        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                @foreach ($postulantes as $postulante)
                    <tr class="cursor-pointer bg-white border-b dark:bg-black dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-opacity-75 font-medium text-gray-900 dark:text-white whitespace-nowrap"
                        wire:click="toggleExpanded({{ $postulante->id }})">
                    ...
                    {{-- @if (isset($this->expandedRows[$postulante->id])) --}}
