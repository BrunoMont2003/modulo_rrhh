<div class="flex flex-col gap-5 w-full">
    <div class="flex py-4 w-full items-center justify-between  dark:border-gray-700 border-b border-gray-200 ">
        @livewire('common.search-box', ['placeholder' => 'Ingrese nombre del empleado'])
            ...
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">
                        <div class="flex items-center">
                            Equipo
                            @livewire('common.sort-button', ['field' => 'equipo'])
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4 text-right inline-flex gap-2 items-center justify-center">
                            <a href="{{ route('empleados.edit', $empleado->id) }}"
                                ...
                                @livewire('icons.edit', [], key('edit-icon-' . $empleado->id))
                            </a>
                            {{-- open modal to delete --}}
                            <button wire:click="confirmEmpleadoDeletion({{ $empleado }})"
                                class="font-medium text-red-600 dark:text-red-500 hover:underline">
                                @livewire('icons.drop', [], key('drop-icon-' . $empleado->id))
                            </button>
